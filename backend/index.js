...
dotenv.config();
//DOTENV IS LIYE ADD KIYA JATA TAKI ENV FILE ADD HOJAYE NHI TO PROCESS.ENV. INVALID BATA HAI
...
import { createorder, verifyandsavepayment } from "./controllers/transaction.controller.js";
...
app.post("/api/v1/payoff",verify, creditCardPayoff
)
