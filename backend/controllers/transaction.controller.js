...
if (isNaN(parsedAmount) || parsedAmount <= 0) {
  ...
  spendingDoc.cashinhand-=parsedAmount;
  spendingDoc.cashless-=parsedAmount
...
const onlinesavepayment = asyncHandler(async (req,res) => {
...
export {createorder,verifyandsavepayment ,cashpayment, alltransactions,transacsuggestion,onlinesavepayment}