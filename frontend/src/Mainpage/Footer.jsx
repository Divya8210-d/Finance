  ...
  return (
    <section id="footer">
      <footer className="bg-gradient-to-l from-orange-100 to-orange-200 text-gray-800 py-10 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8" ref={footer}>
          {/* Contact Info */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li onClick={() => handleScroll("about")}>
                <a className="hover:text-orange-600 cursor-pointer">About</a>
              </li>
              <li onClick={() => handleScroll("features")}>
                <a className="hover:text-orange-600 cursor-pointer">Features</a>
              </li>
          ...
          >
            ...
            <p className="mb-3">
              Get updates about our latest features and feel free to reach out.
            </p>
            <input
              type="email"
