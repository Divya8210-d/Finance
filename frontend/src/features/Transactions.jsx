...
export default function Transactions() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 pt-4 font-inter">
...
<div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
  <h1 className="text-3xl font-extrabold text-gray-800 text-center sm:text-left lg:ml-64 sm:ml-10">
    Transactions
  </h1>
  <motion.img
    src={paidseal}
          ...
          {transactions.length === 0 ? (
            ...
            >
              {transactions.map((txn, index) => (
                <motion.div
                  key={index}
                  className="hover:bg-orange-100 transition flex justify-between items-center p-4 bg-orange-50 border border-gray-200 rounded-xl shadow-sm"
